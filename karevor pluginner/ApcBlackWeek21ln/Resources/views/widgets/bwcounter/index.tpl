    ...
    <div class="black--week21-banner">
        <div class="black--week21-content">                
            <div class="black--week21-counter-cont-img">
                <img class="black--week21-counter-img-desc ic" data-srcset="/custom/plugins/ApcBlackWeek21ln/Resources/images/LicenseNowBannerDesktop.svg" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" alt="">                    
            </div>
            ...
            <div class="black--week21-counter-cont-counter">
                <img class="black--week21-counter-img-mob ic" data-srcset="/custom/plugins/ApcBlackWeek21ln/Resources/images/LicenseNowBannerMobile.svg" src="data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw==" alt="">
            ...
            <div class="black--week21-rabatt-r">
                {s name='txt7'}Geben Sie{/s} <span>"BIGSALENOW"</span> {s name='txt8'} <br>im Bestellprozess ein, um <br>sich  Ihren Rabatt zu sichern.{/s}
            </div>                          
        </div>        
