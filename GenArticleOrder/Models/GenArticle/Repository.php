...
class Repository extends ModelRepository
{
    ...
    public function getArticleSimilarsQueryBuilder($articleId)
    {
        ...
        $builder->select(array('article', 'similar', 'similarDetail'))
                ->from('GenArticleOrder\Models\GenArticle\Article', 'article')
     ...
     * @return \Doctrine\ORM\Query
     */
    public function getArticleSortSimilarQuery($articleId)
    {
    	return $this->getArticleSortSimilarQueryBuilder($articleId)->getQuery();
    }
     ...
     * @return \Doctrine\ORM\QueryBuilder
     */
    public function getArticleSortSimilarQueryBuilder($articleId)
    {
    	$builder = $this->getEntityManager()->createQueryBuilder();
    	$builder->select(array('article', 'sortrelated'))
    	->from('GenArticleOrder\Models\GenArticle\Article', 'article')
    	->leftJoin('article.relatedsimilararticle', 'sortrelated')
    	->where('article.id = :articleId')
    	->orderBy('sortrelated.sort','ASC')
    	->setParameters(array('articleId' => $articleId));
    	try {
     ...
     * @return \Doctrine\ORM\Query
     */
    public function getArticleSortRelatedQuery($articleId)
    {
    	return $this->getArticleSortRelatedQueryBuilder($articleId)->getQuery();
    }
     ...
     * @return \Doctrine\ORM\QueryBuilder
     */
    public function getArticleSortRelatedQueryBuilder($articleId)
    {
    	$builder = $this->getEntityManager()->createQueryBuilder();
    	$builder->select(array('article', 'sortrelated'))
    	->from('GenArticleOrder\Models\GenArticle\Article', 'article')
    	->leftJoin('article.relatedaccessoirearticle', 'sortrelated')
    	->where('article.id = :articleId')
    	->orderBy('sortrelated.sort','ASC')
    	->setParameters(array('articleId' => $articleId));
    	$query = $builder->getQuery();
