...
class Article extends ModelEntity
{
     ...
     * @var ArrayCollection
     *
     * @ORM\ManyToMany(targetEntity="GenArticleOrder\Models\GenArticle\Article")
     ...
     * @Assert\Valid
     *
     * @ORM\OneToMany(targetEntity="GenArticleOrder\Models\GenArticle\Similararticle", mappedBy="article", orphanRemoval=true, cascade={"persist"})
     */
    
    protected $relatedsimilararticle;
     ...
     * @Assert\Valid
     *
     * @ORM\OneToMany(targetEntity="GenArticleOrder\Models\GenArticle\Relatedarticle", mappedBy="article", orphanRemoval=true, cascade={"persist"})
     */
     ...
     * @return ArrayCollection
     */
    public function getRelatedsimilararticle()
    {
    	return $this->relatedsimilararticle;
    }
    
	/**
     * @param ArrayCollection|array|null $relatedsimilararticle
     * @return Article
     */
    public function setRelatedsimilararticle($relatedsimilararticle)
    {
        return $this->setOneToMany($relatedsimilararticle, '\GenArticleOrder\Models\GenArticle\Similararticle', 'relatedsimilararticle', 'article');
    }
    
    /**
     * @return ArrayCollection
     */
    public function getRelatedaccessoirearticle()
    {
    	return $this->relatedaccessoirearticle;
    }
    
    /**
     * @param ArrayCollection|array|null $relatedaccessoirearticle
     * @return Article
     */
    public function setRelatedaccessoirearticle($relatedaccessoirearticle)
    {
    	return $this->setOneToMany($relatedaccessoirearticle, '\GenArticleOrder\Models\GenArticle\Relatedarticle', 'relatedaccessoirearticle', 'article');
    }
